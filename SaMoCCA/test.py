...
from model.SaMoCCA import SaMoCCA
...
if __name__ == '__main__':
    ...
    model = SaMoCCA(args.backbone, args.feature_extractor_path, args.use_original_imgsize)
    model.eval()
    ...
    # tolerate checkpoints saved with or without the DataParallel 'module.' prefix
