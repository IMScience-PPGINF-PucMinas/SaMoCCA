...
class FSSDataset:
    ...
    @classmethod
    def initialize(cls, img_size, datapath, use_original_imgsize, use_saliency=True):
    ...
    def build_dataloader(cls, benchmark, bsz, nworker, fold, split, shot=1):
        ...
        dataset = cls.datasets[benchmark](cls.datapath, fold=fold,
                                          ...
                                          use_saliency=cls.use_saliency, img_size=cls.img_size)
